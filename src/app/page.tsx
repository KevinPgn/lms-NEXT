...
export default function Home() {
  ...
  <div className="px-3">
    ...
    <main className="h-screen max-w-[1400px] mt-32 text-center text-white mx-auto">
      ...
      <p className="text-md text-gray-500 w-[700px] max-md:w-full mt-4 mx-auto">Grouple is a vibrant online community platform that empowerspeople to connect, collaborate, and culitivate meaningfulrelationships</p>
      ...
      <div className="absolute w-full h-full max-xl:hidden bg-white/10 -z-10 opacity-50 rounded-full blur-xl"></div>
